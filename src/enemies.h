...
#define ENEMY_STATE_COOLDOWN 4
#define ENEMY_STATE_ITEM 5
...
#define ENEMY_TYPE_SNIPER   4
#define ENEMY_TYPE_ARROW    5
#define ENEMY_TYPE_GHOST    6
#define ENEMY_TYPE_FIREBALL 7
#define ENEMY_TYPE_SKELETON_BOSS 8
#define ENEMY_TYPE_CULTIST_BOSS 9
#define ENEMY_TYPE_GHOSTBAT 10
